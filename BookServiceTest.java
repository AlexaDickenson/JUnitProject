...
public class BookServiceTest {
    ...
    public void searchBookTitleMatch() {
        Book book1 = new Book("Echoes of Eternity", "Elysia Winterborne", "Fantasy", 20.95);
        Book book2 = new Book("Whispers in the Mist", "Sofia Rodriguez", "Fantasy", 25.50);
        List<Book> books = new ArrayList<>();
        books.add(book1);
        books.add(book2);
        when(bookDatabase.stream()).thenReturn(books.stream()); //set up mock behavior for book database
        List<Book> results = bookService.searchBook("Echoes of Eternity");  //searching for book by title
    ...
    public void purchaseBookInsufficientBalance() {
        Book book1 = new Book("Echoes of Eternity", "Elysia Winterborne", "Fantasy", 20.95);
        User user = new User("SparkleDreamer87", " Myst3ry@2023", "sparkle.dreamer87@gmail.com", 15.30);
    ...
    public void addBookReviewEdgeCase() {
        Book book = new Book("Echoes of Eternity", "Elysia Winterborne", "Fantasy", 20.95);
        User user = new User("SparkleDreamer87", " Myst3ry@2023", "sparkle.dreamer87@gmail.com", 50.34);
        String review = "Great book!";
        boolean result = bookService.addBookReview(user, book, review); //add book review
